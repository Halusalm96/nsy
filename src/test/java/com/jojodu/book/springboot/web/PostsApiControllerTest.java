...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT, classes = PostsApiControllerTest.TestConfig.class)
@AutoConfigureMockMvc
public class PostsApiControllerTest {

    @Configuration
    @ComponentScan(basePackages = {"com.jojodu.book.springboot"})
...
//
//        HttpEntity<PostsSaveRequestDto> requestEntity = new HttpEntity<>(requestDto, headers);
//
...
//        ResponseEntity<Long> responseEntity = restTemplate.exchange(url, HttpMethod.PUT, requestEntity, Long.class);
        ...
        //when & then
        mvc.perform(put(url)  // PUT 방식으로 변경
                        .contentType(MediaType.APPLICATION_JSON_UTF8)
                        .content(new ObjectMapper().writeValueAsString(requestDto)))
                .andExpect(status().isOk());
